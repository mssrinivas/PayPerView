                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div  style={{display:'flex'}} >&nbsp;&nbsp;&nbsp;&nbsp;
                          ...
                          <div className="row mt-3 mb-1 justify-content-center" >
                                ...
                                <CruzCardSalaryGoogle paid={this.state.subscribedtoGoogle} value="google"/>
                                {BUTTONFORGOOGLE}                     
                                ...
                                <CruzCardSalaryFacebook paid={this.state.subscribedtoFacebook}/>
                                {BUTTONFORFACEBOOK}
                                <div className="row mt-3 mb-1 justify-content-center" >
                                <div className="col col-md-10">
                                    <h2>Amazon</h2>
                                ...
                                <CruzCardSalaryAmazon paid={this.state.subscribedtoAmazon}/> 
                                {BUTTONFORAMAZON}
                                <div className="row mt-3 mb-1 justify-content-center" >
                                <div className="col col-md-10">
                                    <h2>LinkedIn</h2>
                                ...
                                <CruzCardSalaryLinkedIn paid={this.state.subscribedtoLinkedIn} onSubscribe={this.subscribe}/>
                                {BUTTONFORLINKEDIN}
                                <div className="row mt-3 mb-1 justify-content-center" >
                                <div className="col col-md-10">
                                    <h2>Netflix</h2>
                                ...
                                <CruzCardSalaryNetflix paid={this.state.subscribedtoNetflix}/> 
                                {BUTTONFORNETFLIX}                             
                            </div>
